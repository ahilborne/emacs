...
(custom-theme-set-faces
 ...
 '(csv-separator-face ((((class color) (min-colors 89)) (:foreground "#ff9800"))))
 ...
 '(magit-diff-file-heading-selection ((t (:background "#263238" :foreground "#ff9800" :weight bold))))
 '(magit-diff-hunk-heading ((t (:background "#455A64"))))
 '(magit-diff-hunk-heading-highlight ((t (:background "#455A64"))))
 '(magit-diff-hunk-heading-selection ((t (:background "#263238" :foreground "#ff9800"))))
 '(magit-diff-lines-heading ((t (:background "#ff9800" :foreground "#263238"))))
...
;; XXX '(org-block-background ((t (:background "#1c1f26"))))
;; XXX '(org-code ((((class color) (min-colors 89)) (:foreground "#8bc34a" :background "#1c1f26"))))
